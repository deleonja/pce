...
implements \cpnote{porque en italicas? Me cae gordo} the PCEG $\mcG_{\vec \alpha}$ when $t\to \infty$,
\begin{align}
...
We now show that PCE channels can also be implemented with \textit{simple
...
de colision}. To do this, observe that using the Stinespring dilation theorem~\cite{Stinespring2006}, PCEGs can
