...
Siento que la introduccion propuesta esta un poco debil}
...
{\blue [nuevo, sigo trabajando] It is known that not every quantum channel can be seen as a snapshot of a Markovian decoherence process~\cite{cirac,davalosdivisibility}, \ie{} a process described with a Markovian master equation,
\begin{multline}
