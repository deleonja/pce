...
{\blue [anterior] It is known that not every quantum channel can be seen as a
snapshot of a Markovian decoherence process~\cite{cirac,davalosdivisibility},
\ie{} a process described with a Markovian master
...
%
In the particular case where the Hamiltonian, relaxation rations and Lindblad operators are independent of time, we recover the well-known Lindblad master equations~\cite{lindblad}. Such equations model time-homogeneous processes, implying one-parameter semigroup structures that will be exploited later.
%
...
{\red [nuevo]
Lindblad processes arise naturally in many theoretical~\cite{} and
experimental~\cite{} settings and are archetypical in decoherence dynamics. 
