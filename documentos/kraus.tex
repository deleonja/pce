...
\begin{equation}
\mcG_{\vec \alpha}[\rho]:=\tr_{\text{qubit}} \left( U_{\vec \alpha} \rho\otimes \projj{0} U^\dagger{}_{\vec \alpha} \right),
\end{equation}
