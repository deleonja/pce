...
{\blue [nuevo] It is known that not every quantum channel can be seen as a snapshot of a Markovian decoherence process~\cite{cirac,davalosdivisibility}, \ie{} a process described with a Markovian master equation~\cite{lindblad,kossa,kossa2,Gorini1976},
\begin{multline}
