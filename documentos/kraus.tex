...
Inspection of the Kraus operators for two\janote{-}qubit PCEGs leads to
...
\label{eq:kraus:PCE}
\end{equation}
since the Kraus operators corresponding to \janote{\sout{a}} single-qubit PCEs are 
...
\end{equation}
where $\tr_{\text{E}}$ is the partial trace over the whole ancillary qubits. Notice that as PCEGs commute, the order of the collisions is irrelevant.
% \begin{itemize}
