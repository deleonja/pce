...
%
Besides, these processes lead to a monotonically lose of information~\cite{breuerreview} and describe non invertible channels in the asymptotic limit $t\to \infty$. Furthermore, channels belonging to one-parameter semigroup families usually have non-negative eigenvalues~\cite{davalosdivisibility}
%
Thus we might ask whether 
 \pce{} channels erase information
The first
one consist in identifying each \pce{} channel as a fixed point of some pure
dissipative process. The second, in identifying each \pce{} channel as fixed
points of some memory-less collision model.
