...
\eqref{eq:kraus:PCE} on an $N$ qubit system:\janote{acá abajo tenías un $\&$ dentro 
del entorno \texttt{equation} y no compilaba}\janote{había otro en algún lado que quité 
también.}
\begin{equation}
% \begin{align}
\rho 
