...
by the Kraus operators in \eref{eq:kraus:PCE} is a PCE channel. Moreover, one can notice that, 
...
then extending to more general channels. 
...
time-homogeneous Markovian process, which are always characterized by some
