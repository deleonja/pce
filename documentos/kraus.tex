...
experimental~\cite{PhysRevA.67.042322} \ddnote{aqui hace falta buscar mas citas, estoy buscando algo relacionado con la optical master equation, el pedo es que creo que esas ondas son time-dependent} settings and are archetypical in decoherence dynamics. \ddnote{añado esto a ver si gusta, motiva el hecho de que los PCEs sean puntos limite y no "puntos intermedios"} {\blue Moreover, these processes lead to a monotonically lose of information~\cite{breuerreview} and describe non invertible channels in the asymptotic limit $t\to \infty$ (this can be seen from the monotonically decreasing of the determinant, see Ref.~\cite{cirac}).}
