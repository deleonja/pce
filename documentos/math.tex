...
\end{equation}
\janote{Ojo que cambié la eq. \eqref{eq:vectorized_pauli_strings}. Eso también
modifica el comentario de la frase que le sigue a este comentario. Luego lo cambio yo}
