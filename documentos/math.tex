...
% Intro {{{
This section is devoted to derive the conditions a Pauli map need to satisfy to
fulfill the CP condition i.e. that all the eigenvalues of the Choi matrix
associated to the channel must be non-negative.  To do so, we calculate
and diagonalize the matrix associated with general Pauli maps, first for a
