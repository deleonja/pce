...
To do so, we first calculate and diagonalize the matrix associated with the map, 
first for a single qubit and then for $N$ qubits. We then associate a vector space
...
After some steps it is possible to show that the associated Choi matrix reads
% 
\begin{equation}
