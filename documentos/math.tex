...
% Intro {{{
This section is devoted to derive the conditions a Pauli map needs to satisfy 
...
and diagonalize the Choi matrix associated with general Pauli maps, first for a
...
given by  $\bbrakket{A_1}{A_2}=\tr A_1^\star A_2$,
...
% vectorized 
elements of the Pauli basis and satisfy the relation 
...
{\red The same program can be carried out for $N$ qubits. In this case, 
the vectorized Pauli operators are 
\begin{align}
\kket{\sigma_{\vec{\alpha} }}&=\kket{\sigma_{\alpha_1}}\otimes\cdots
\otimes\kket{\sigma_{\alpha_N}} 
\nonumber \\
&=\kket{\sigma_{\alpha_1}\otimes\cdots
\otimes\sigma_{\alpha_N}},
\end{align}}
\ddnote{Mi edit: The same program can be carried out for $N$ qubits. In this case, 
