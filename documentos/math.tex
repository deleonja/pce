...
\cpnote{Aca Francois escribio algo que puede sustituir 
el inicio del parrafo, pero estoy esperando la fuente }
...
\cpnote{Aca tambien metio un rollo Francois que resulta muy util.}
...
$\kket{\sigma_{\vec{\alpha} }}=\kket{\sigma_{\alpha_1}\otimes\cdots
\otimes\sigma_{\alpha_N}}$}, and satisfy the orthogonality relation
