...
We now construct the Choi matrix of a single\janote{-}qubit Pauli diagonal map
...
\end{equation}
% \janote{Cambié la eq. \eqref{eq:vectorized_pauli_strings}. Eso también
% modificó la frase que le sigue a este comentario.}
This vectorization must not be confused with the 
%direct vectorization of $\sigma_{\vec \alpha}$
