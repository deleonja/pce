...
\begin{abstract} % {{{
In this work we generalize the notion that collapsing the Bloch sphere into a disk with unity radius is not a quantum channel to the case of an arbitrary number of qubits. This is, we study and characterize all generalized idempotent Pauli channels to the case of $N$ qubits
\end{abstract} % }}}
%%
