...
\begin{abstract} % {{{
We generalize the notion that collapsing the Bloch sphere into a disk with unity radius is not a quantum channel, to the case of an arbitrary number of qubits. This is, we study and characterize all generalized idempotent Pauli channels to the case of $N$ qubits. The generalization is obtained by extending Pauli matrices to Pauli strings. We give a complete characterization of completely positive maps of this type by means of interpreting channels' matrices as discrete vector spaces. Moreover, we show that the obtained family of idempotent channels has the structure of a semigroup, and derive its generators. We use this simple structure to derive physical implementations and connect the derived family of channels with Markovian processes.
\end{abstract} % }}}
%%
