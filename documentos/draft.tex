...
\item explicar porque la generalizacion a n niveles no es directa. 
\end{itemize}
...
\item Linealidad de los eigenvalores de la matriz de Choi en función de las $\tau_{j_1\ldots,j_n}$ de canales `\textit{component erasing}' de qudits. \afnote{Relación con canales citados en \cite{Siudzinska2020}?}
\item \afnote{Clasificación de las clases de canales PCE: Entanglement breaking, divisible...}
\item \afnote{Los canales PCE tienen algún efecto sobre propiedades de estados como entrelazamiento, coherencia, no-localidad, etc?}
\item \afnote{Geometria de los canales de Pauli para $N$ qubits \cite{Siudzinska2019}.}
\end{itemize}
...
\item \afnote{Creo que podemos definir primero los PCE y luego si presentar la formalización de espacios vectoriales de François.}
\item Los espacios vectoriales de francois
\item Derivaciones y resultados \afnote{Caracterización PCEs?}
