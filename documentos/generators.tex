...
all of the PCE's and the existence of these generators may be explained with 
the vector space point of view.}

\esqueletoja{The matrix $\san$ [see \eref{eq:san}] encodes all the information
of PCE generators and, therefore, of PCE quantum channels.}

\esqueletoja{Given the existence of PCE generators one can cons}
