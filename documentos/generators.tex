...
$\vec\alpha$, and therefore, denoted as $\pceg$. El numero de generadores 
concide con esa vaina. 
PCE generators $\pceg$ may be classified by its local action on 
all individual qubits in the system.
\cpnote{Acuerdate de la referencia a la figura 4}
...
\cpnote{Acuerdate de otra referencia a la figura 4}
