...
in the system. This action can be encoded in the same vector index $\vec\alpha$
introduced in \eqref{eq:pauli_strings}, hence each of the different $4^N$ 
vector indices may be related uniquely to each of the PCE generators
