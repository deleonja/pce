...
\end{equation}
% and the associated 
The map have the following properties:
\begin{enumerate}
...
Finally, it is worth pointing out that $\san$ (and thus $a$) [see \eref{eq:san}] 
...
$-1$s with $0$s. 
The proof \janote{of this connection between PCEGs and $A$} is given in \appref{sec:2_qubits}, and in \fref{fig:A_and_PCEGs_connection} we illustrate
