...
% \cpnote{Revisar este párrfo. Solo ha pasado una persona por ahi}
% 
% 
...
\caption{Connection between rows and columns of $a$ and single qubit PCE
generators. We also include the corresponding 
labels $\mcG_\alpha$ of the generators.
% The rows or columns of $a$ and the diagrams of the generators are either 
% symmetric or anti-symmetric under reflection.
% \cpnote{Mejorar figura, poner matriz de tamano normal, poner loslabels de los generadores, mejorrar el caption, cambiar los cuadrios.}
}
