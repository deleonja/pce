...
\begin{equation}
\left\{\openone/\sqrt2, \left(\bigotimes_k \sigma_{i_k}\right)/\sqrt2\right\}. 
\label{}
\end{equation}
...
\eref{eq:kraus:PCE} on an $n$ qubit system with Bloch sphere representation \eref{eq:nqubit:bloch},
\begin{align}
\mcM[\rho] &= 
\frac{\openone}{\sqrt{2}} \rho\frac{\openone}{\sqrt{2}} 
 + 
