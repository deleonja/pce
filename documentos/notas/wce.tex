...
using two indices for the components $\tau_{\mu\nu}$ to characterize a WCE
we can represent the 3-level systems WCE quantum channels as in Fig. 
\ref{fig:weylCE_1particle_d3}.
\begin{figure}[h]
	\centering
	\includegraphics[width=10cm]{weylCE_1particle_d3}
...
so-called \textit{rainbow rule} is weirdly followed: 1 3 6 3 1 number of 
