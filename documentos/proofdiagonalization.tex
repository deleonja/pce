...
\ddnote{Alejo, por fa revise q no se me fue un typo con el asunto de mod 2, ya corregí toda la notación y removi los otros comentarios, que ya fueron aclarados en la reunion y trataban de lo mismo}
...
since $ (-1)^{j+(j+ k (\text{mod} 2))} = (-1)^k $ \ddnote{Alejo, por fas checa esto, se me hace curioso que el modulo 2 solo este solo en la segunda suma del exponente}. To continue, we 
