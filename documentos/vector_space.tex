...
% Examples of diagrams for several 2-qubit PCE quantum channels: (a) the totally
% depolarizing channel, (b) a PCE channel that preserves four components.
% (c), (d) and (e) show three generators \cpnote{Quizá poner los nombres de los
% generadores acá}; the combination of any two of them yields the channel in (b).
...
Examples of diagrams for several 2-qubit PCE quantum channels: (a) the totally
depolarizing channel, (b) a PCE channel that preserves four components, the
