...
\ddnote{propongo channels as vector spaces como titulo de seccion, pues lo actual se entiende mas en el sentido estandar: canales como miembros de un espacio vectorial, que tambien es cierto, pero no es el punto aqui}
...
Pauli channel, as in \eref{eq:definition:Pauli}\janote{referencia rota}. 
...
operation $\oplus$. Doing so, in an ordered way, allows one to generate
...
has $q^d$ elements~\cite{CitaAlgebraLineal}.
