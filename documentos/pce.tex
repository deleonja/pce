...
of the density matrix in the complete orthonormal basis $\left\{ \frac{1}{2^{N/2}}\sigma_{\vec
...
\end{equation}
These operations are diagonal in the basis $1/2^{N/2} \left\{\sigma_{\vec \alpha} \right\}_{\vec \alpha}$
 \cpnote{davalos, dale aca un pequeño 
