...
\cpnote{Revisar despues de escribir la intro que no se ha introducido la sigla}
...
\eref{eq:N_qubits_rho}. For a given PCE, we shall fill  \janote{Jose Alfredo quizá itera}
