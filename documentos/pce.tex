...
in this article to determine with $\taus$ lead to a valid quantum map \janote{está 
incompleto este enunciado, no?}. 
...
A graphical representation for 1, 2 and 3 qubits \janote{PCE maps} may be introduced, being the
two qubits case what has proved \janote{\sout{more}} \janote{to be the most} useful. Consider a $N$ dimensional 
\janote{cartesian} grid, with $4^N$ places. \janote{We label} Each place has $N$ integer coordinates, ranging
