...
\cpnote{Cambios importantes, qeu David revise}
...
if and only \choi (also called dynamical matrix) is positive-semidefinite.
...
positive trace perserving map. For the operation to be trace preserving, it is
