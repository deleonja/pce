...
% 	\sigma_{\alpha_1}\otimes \ldots \otimes \sigma_{\alpha_N},
	%r_{0,\ldots,0}=1,
\end{equation}
where $\vec \alpha$ denotes a multi index with $N$ components, 
...
$\tr \sigma_\valpha=\delta_{\valpha,\vec 0}$, $r_{\vec 0}=1$. 
...
To preserve the trace of the density matrix, we require that 
$\tau_{\vec 0}=1$. 
