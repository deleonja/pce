...
It can be seen from Kraus decomposition that quantum channels preserve hermiticity, this has a practical consequence when using hermitian bases. $\hat \mcE_{ij}=1/2^N\tr\left( \sigma_i \mcE[\sigma_j]
 \right)$
