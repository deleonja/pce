...
E is totally positive if trivially extending E to the tensor product of H with an arbitrary dimensional ancilla space yields a positive operation. }\ddnote{ejecutado}. Therefore,
...
}\ddnote{trabajando en ello, hacia falta edicion aqui}
