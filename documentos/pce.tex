...
de 1 qubit' y hace falta una transición de lo de arriba a los PCE. Propongo lo siguiente:}
...
We shall start exploring \sout{a}\janote{the} single qubit scenario, where the most general 
