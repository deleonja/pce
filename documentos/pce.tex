...
positive~\cite{bengtsson_zyczkowski_2017}\janote{El comando de cita aparecía vacío. 
Yo agregué la del GofQS}.  Quantum channels are required to be completely positive
...
if and only \choi (also called \janote{Choi or} dynamical matrix \janote{of $\mcE$}) 
\janote{en el resto del manuscrito siempre usamos Choi matrix}
