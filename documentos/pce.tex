...
If we refer to the map  $\paulicomponents \mapsto \taus \paulicomponents$, 
with arbitrary values of 
% but allow the 
$\taus$ (only restricted by complete positivity) as Pauli diagonal operations. 
...
It is worth noticing that the set of \pce{} maps \R{A2} overlaps with the set
