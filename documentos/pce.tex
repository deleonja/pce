...
\end{equation}
We will show later that this can be trivially generalized to the $N$ qubit case. \ddnote{[Esto se mueve a la seccion correspondiente:]}
\begin{equation}
...
\end{align}
similar to the semigroup generator, we will show later that this can be trivially generalized to the $N$ qubit case. \ddnote{[Esto se mueve a la seccion correspondiente:]}
\begin{align}
