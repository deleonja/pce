...
\end{equation}
Similar to the qubit case, not every operation with this form is a \cptp{} map. For the operation to be trace preserving, it is easy to prove that $\tau_{\vec 0}=1$. In the other hand, constructing and evaluating the conditions for complete positivity is involved and is the main problem addressed in this paper.  
...
% \end{split}
\end{equation}
 determine which $\taus$ lead to a valid quantum map.
...
frases de la importancia de esta familia.} \ddnote{hecho}.
% Notice
