...
\end{align}
where the partial trace over everything except qubit $k$ is
denoted by $\tr_{\not k}$; \janote{note that Pauli components of $\rho_k$
are of the form $r_{0,\ldots,j_k,\ldots,0}$. Therefore,
the action of the single qubit generator in the
last line of \eqref{eq:generator:individual:qubit} act on $\rho_k$
as $r_{0,\ldots,j_k,\ldots,0}
\mapsto \tau_{0,\ldots,j_k,\ldots,0}r_{0,\ldots,j_k,\ldots,0}$.}  
