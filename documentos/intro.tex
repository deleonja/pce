...
increases overwhelmingly rapid respect to the dimension of the Hilbert space.
...
(the complete positivity condition imposes the regions that physical meaning,
...
de particulas.}. Therefore, even the
...
sphere~\cite{ruskai}\cpnote{QQ}. Thus, understanding families of channels sharing a common
property usually gives a good insight about the jungle of quantum operations.
For the qubit case there are several studies concerning the unital case, which
...
In~Ref.~\cite{nathanson2007pauli} authors define families of unital channels as
...
discutir que familias mencionamos acá}
