...
basis of Pauli strings which, that is, these maps erase single and multi-particle
coherences of a many-body quantum system; 
...
However we show that the components of PCE quantum channels form a finite vector space.
...
%
Similar to other objects in open quantum systems (for example Lindblad operators), 
PCE quantum channels form a semigroup, in this case finite.  

, where the generators  are generalized
