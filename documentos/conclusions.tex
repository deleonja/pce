...
we call  those maps Pauli component erasing (PCE) maps.
...
This in turn allows to unravel several properties, such as the possible number of PCE
...
quantum channels with a very special mathematical structure that allows to
