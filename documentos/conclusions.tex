...
{\blue \begin{itemize}
\item We generalize Pauli flip operations to the $N$ qubit case, in particular generators have  a simple generalization of the same Kraus operators as for the qubit case, just extending $\sigma_i \mapsto \sigma_{\vec \alpha}$. Therefore 
\end{itemize}
}
