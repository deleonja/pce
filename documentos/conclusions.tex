...
and dephasing channels\cpnote{ver que recordamos estas definiciones en el texto}\ddnote{dephasing solo se menciona en la Fig 1}{\blue , see~\fref{fig:one:qubit:examples}};
...
operators \ddnote{processes}), PCE quantum channels form a semigroup, in this case finite.  For
...
these channels of\ddnote{or} connect them with already existent decoherence families. 
% \ddnote{Lo anterior todavia lo siento como una lista sin mucha interconexcion. Contrapropuesta ya completa:}
This, together the discovered algebraic structure that translates complete
...
Both generalizations (such as going from qubits to qudits) and
