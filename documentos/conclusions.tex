...
basis of Pauli strings which\janote{quitar `which', creo que estás de más}, that is, these maps erase single and multi-particle
...
given by the Choi-\jami{} isomorphism, \janote{task} after which we showed that
...
processes), PCE quantum channels form a semigroup, \janote{but finite in this case}
in this case finite.  For
