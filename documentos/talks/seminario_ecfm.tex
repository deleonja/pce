...
\begin{frame}[t]
Estados de un sistema cuántico de dos niveles:
...
\begin{frame}
Dos tipos de evolución de un sistema de 2 niveles:
...
\node at (-6.5,1.1) {\LARGE evolución};
\node at (-6.5,0.6) {\LARGE no física};
