...
\begin{frame}[t]{}{Sistema de dos niveles}
...
\begin{center}
\includegraphics[width=5cm]{../images/bloch_rho}
Estados mixtos \textbf{y puros}
\end{center}
\end{minipage}
\end{frame}
...
\begin{center}
\includegraphics[width=\textwidth]{../images/dibujo}
\end{center}
\end{minipage}
\hfill
\begin{minipage}{.4\textwidth}
Si ahora consideramos un sistema de muchas partículas de 
dos niveles, ¿cuáles son las proyecciones de la hiperesfera de Bloch
que describen evoluciones físicas? 
\end{minipage}
\end{frame}
