...
\author[]{Carlos Pineda$^\dagger$\\
\footnotesize
David Dávalos$^\dagger$, Antonio Rosado$^\dagger$ y Carlos Viviescas$^*$
}
\institute[c. pineda]{$^\dagger$Instituto de Física, UNAM \\$^*$Universidad Nacional de Colombia}
\date[]{
\centering
